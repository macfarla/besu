...
- Add `eth_getTransactionBySenderAndNonce` JSON-RPC method to look up a mined transaction by sender address and nonce [#10284](https://github.com/besu-eth/besu/issues/10284)
