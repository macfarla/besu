# [LFDT Code of Conduct](https://www.lfdecentralizedtrust.org/code-of-conduct)

Besu is a collaborative project at The Linux Foundation Decentralized Trust. It is an open-source and open
...
community, which LFDT will not tolerate.
...
This code (**CoC**) applies to any member of the LFDT community – developers, participants in
...
LFDT is committed to maintain a **positive** [work environment](#work-environment). This
...
- Staff members
- Anyone from the Public partaking in the LFDT work environment (e.g. contribute code,
