...
public class EngineGetClientVersionV1 extends ExecutionEngineJsonRpcMethod {
  ...
  public JsonRpcResponse syncResponse(final JsonRpcRequestContext request) {
    ...
    // TODO get the actual commit hash
    final String commit = "";
    final EngineGetClientVersionResultV1 engineGetPayloadBodiesResultV1 =
        new EngineGetClientVersionResultV1(clientVersion, commit);
